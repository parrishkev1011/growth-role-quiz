...
const ROLE_COPY = {
  architect: {
    title: "The Architect",
    paragraph:
      "You’re someone who naturally looks for structure before you move. When things feel messy or uncertain, your instinct is to slow down and make sense of what’s really happening beneath the surface. You think in systems, patterns, and long-term outcomes, which means you’re often the one who brings clarity when others feel overwhelmed. You’re not indecisive — you’re deliberate — and when you act, it’s usually because the plan actually makes sense.",
    strength: "You turn complexity into clear direction.",
    friction: "You can stay in planning mode longer than necessary.",
  },
  driver: {
    title: "The Driver",
    paragraph:
      "You’re wired for movement. When something needs to happen, your instinct is to act rather than analyze. You gain clarity through motion, not overthinking, and you’re often the one who pushes things forward when others are still deciding. You’re comfortable making calls with incomplete information, trusting that momentum will reveal what needs to be adjusted along the way.",
    strength: "You create progress and energy quickly.",
    friction:
      "You can move faster than the situation — or the people around you — can handle.",
  },
  guide: {
    title: "The Guide",
    paragraph:
      "You’re naturally attuned to people. You notice tone, energy, and unspoken dynamics, often before anything is said out loud. When others feel uncertain or disconnected, you tend to step in to create understanding and alignment. You’re less focused on pushing outcomes and more focused on making sure people feel seen, heard, and supported as things move forward.",
    strength: "You create trust and emotional clarity.",
    friction: "You can carry responsibility for others longer than is healthy.",
  },
  builder: {
    title: "The Builder",
    paragraph:
      "You’re naturally focused on creating things that last. When others are energized by ideas or momentum, you’re thinking about how something actually gets built, maintained, and improved over time. You value reliability, consistency, and systems that don’t fall apart under pressure. You’re often the person who turns plans into something solid and repeatable.",
    strength: "You build stable systems people can rely on.",
    friction: "You can resist change if it threatens what’s already working.",
  },
  stabilizer: {
    title: "The Stabilizer",
    paragraph:
      "You’re someone people rely on when things feel uncertain. You bring steadiness, patience, and calm to situations that might overwhelm others. While you may not seek attention or speed, your presence helps keep things grounded and manageable. You value balance, consistency, and making sure nothing spirals out of control.",
    strength: "You create calm and reliability under pressure.",
    friction:
      "You can stay in situations longer than you should to keep things stable.",
  },
  visionary: {
    title: "The Visionary",
    paragraph:
      "You naturally think ahead. While others focus on what’s happening now, your attention is already on what’s coming next and how today’s choices shape the future. You’re drawn to patterns, possibilities, and connections that aren’t obvious yet. You’re often the one introducing new perspectives, directions, or ideas that help others see beyond the present moment.",
    ...
    <main style={styles.page}>
      <div style={styles.wrap}>
        <header style={styles.hero}>
          <div>
            <div style={styles.kicker}>Fast • personal • not clinical</div>
            <h1 style={styles.h1}>What’s your Growth Role?</h1>
            <p style={styles.sub}>
              A quick, social quiz that gives you a clear snapshot of how you’re wired—especially under pressure.
              You’ll get one role plus a short read that feels surprisingly accurate.
            </p>
          </div>
        </header>
